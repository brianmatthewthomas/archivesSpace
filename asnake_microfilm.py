...
for archival_object in tqdm(archival_objects):
    ...
    print(res_record)
    output = open("../../.config/JetBrains/PyCharmCE2021.3/scratches/sample.json", "w")
    ...
    for instance in res_record['instances']:
        ...
        if 'type_3' in instance['sub_container']:
            ...
            if instance['sub_container']['type_3'] == "Microfilm":
                print("yes")
                selection = True
                exists = False
                temp1 = "Microfilm"
                ...
                if response['response']['numFound'] > 0:
                    for widget in response['response']['docs']:
                        listy.append({'jsonmodel_type': 'instance', 'instance_type': 'microform',
        ...
        if 'type_2' in instance['sub_container']:
            ...
            if instance['sub_container']['type_2'] == "Microfilm":
                print("yes")
                selection = True
                exists = False
                temp1 = "Microfilm"
